...
/*   Updated: 2023/10/14 15:18:32 by jyao             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm &aformREF) const
{
	try {
		aformREF.beSigned(*this);
		std::cout << *this
			<< " signed "
			<< aformREF
			<< std::endl;
...
void	Bureaucrat::executeForm(AForm &aformREF) const
{
	try {
		aformREF.execute(*this);
		std::cout << *this
			<< " executed "
			<< aformREF
			<< std::endl;
